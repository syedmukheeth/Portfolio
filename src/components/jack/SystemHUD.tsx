...
export const SystemHUD = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[500] p-6 md:p-12 lg:p-16 flex flex-col justify-between mono text-[9px] md:text-[10px] uppercase tracking-[0.3em] text-white/60">
