...
export default function Home() {
  ...
  return (
    <div className={cn(
      ...
      <div className="fixed bottom-4 left-4 z-[100] font-mono text-[8px] uppercase tracking-[0.3em] text-white/20 pointer-events-none">
        <span className="text-accent animate-pulse">●</span> Syed_Systems_v9.2.4_STABLE
      </div>
      
      {/* CINEMATIC FOOTER */}
      <footer id="contact" className="py-32 bg-[#0C0C0C] border-t border-white/5 relative overflow-hidden">
        <div className="container max-w-6xl mx-auto px-4 relative z-10">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
              <div>
                 ...
                 <p className="text-[#D7E2EA]/40 text-lg max-w-sm mb-12">
                 ...
                 <a 
                    ...
                    className="text-2xl md:text-4xl font-medium text-[#D7E2EA] hover:text-accent transition-colors underline underline-offset-8"
                 >
              ...
              <div className="flex flex-col gap-6 md:items-end">
                 {SOCIAL_LINKS.map(link => (
                   <a 
                     ...
                     target="_blank"
                     rel="noopener noreferrer"
                     className="text-xl uppercase tracking-widest text-[#D7E2EA]/40 hover:text-white transition-all flex items-center gap-4 group"
                   >
           ...
           <div className="mt-40 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between gap-8 items-center">
              <div className="text-[10px] uppercase tracking-[0.4em] text-white/20">Designed & Engineered &copy; 2026 Syed Mukheeth</div>
              <div className="font-mono text-[8px] uppercase tracking-widest text-accent/40 bg-accent/5 px-4 py-2 rounded-full border border-accent/10">
                 Infrastructure: Parallel_System_v4_Node_01
              </div>
           </div>
        </div>
